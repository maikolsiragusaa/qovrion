        ...
        Group {
            ...
            case .notBootstrapped, .dormant:
                PlanConnectView(
                    ...
                    message: "Metrora will read your Claude Code credentials once. macOS will ask permission. After that, the live quota bar shows next to the Claude tab and updates automatically."
        ...
        Group {
            ...
            case .notBootstrapped, .dormant:
                PlanConnectView(
                    ...
                    message: "Metrora will read your Codex CLI credentials once. After that, the live quota bar shows next to the Codex tab and updates automatically."
